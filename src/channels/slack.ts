...
export class SlackChannel {
    ...
    constructor() {
        ...
        if (!this.webhookUrl) {
            logger.warn('SLACK_WEBHOOK_URL not found, escalation alerts will be disabled.');
        }
    }

    async sendEscalation(chatJid: string, userName: string, text: string): Promise<boolean> {
