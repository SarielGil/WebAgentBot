...
export class GitHubService {
    ...
    async createMilestone(owner: string, repo: string, title: string, description: string = ''): Promise<void> {
        try {
            ...
            logger.error({ err, repo, milestone: title }, 'Failed to create milestone');
        }
    }
